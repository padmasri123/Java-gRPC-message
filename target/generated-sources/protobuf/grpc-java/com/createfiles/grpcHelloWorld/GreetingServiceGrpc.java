...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.createfiles.grpcHelloWorld.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.createfiles.grpcHelloWorld.HelloRequest,
      com.createfiles.grpcHelloWorld.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.createfiles.grpcHelloWorld.HelloRequest.class,
      responseType = com.createfiles.grpcHelloWorld.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.createfiles.grpcHelloWorld.HelloRequest,
      com.createfiles.grpcHelloWorld.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.createfiles.grpcHelloWorld.HelloRequest, com.createfiles.grpcHelloWorld.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod = 
              io.grpc.MethodDescriptor.<com.createfiles.grpcHelloWorld.HelloRequest, com.createfiles.grpcHelloWorld.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.createfiles.grpcHelloWorld.GreetingService", "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.createfiles.grpcHelloWorld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.createfiles.grpcHelloWorld.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.createfiles.grpcHelloWorld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.createfiles.grpcHelloWorld.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.createfiles.grpcHelloWorld.HelloRequest,
                com.createfiles.grpcHelloWorld.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.createfiles.grpcHelloWorld.HelloResponse greeting(com.createfiles.grpcHelloWorld.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.createfiles.grpcHelloWorld.HelloResponse> greeting(
        com.createfiles.grpcHelloWorld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.createfiles.grpcHelloWorld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.createfiles.grpcHelloWorld.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.createfiles.grpcHelloWorld.GreetingServiceOuterClass.getDescriptor();
    }
